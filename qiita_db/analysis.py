            ...
            for label, tables in viewitems(grouped_samples):
                ...
                if post_processing_cmds:
                    ...
                    for cmd in post_processing_cmds:
                        ...
                        biom_files.append((data_type,
                                           p_out['biom'],
                                           p_out['archive']))
                else:
                    # if there are no post_processing_cmds to iterate
                    # over, then the final result is returned below.
                    # (a biom_fp, without any archiving artifact.)
