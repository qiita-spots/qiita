...
sql_cols = """INSERT INTO qiita.study_sample_columns
              ...
              VALUES (%s, 'physical_specimen_location', 'varchar'),
                     ...
                     (%s, 'latitude', 'float8'),
                     (%s, 'longitude', 'float8'),
                     (%s, 'required_sample_info_status', 'varchar')"""
...
ALTER TABLE qiita.{0} ADD COLUMN required_sample_info_status varchar;"""
...
for s_id in study_ids:
    ...
    # 10 -> the number of rows that we are adding, see `sql_cols`
    conn_handler.add_to_queue(queue_name, sql_cols, [s_id] * 10)
    ...
    for sample_data in data:
        ...
        conn_handler.add_to_queue(
            ...
            (sample_data['physical_location'],
             ...
             sample_data['required_sample_info_status'],
