...
CREATE INDEX idx_parameter_artifact_type ON qiita.parameter_artifact_type ( command_parameter_id ) ;
CREATE INDEX idx_parameter_artifact_type ON qiita.parameter_artifact_type ( artifact_type_id ) ;
...
CREATE INDEX idx_command_output ON qiita.command_output ( command_id ) ;
CREATE INDEX idx_command_output ON qiita.command_output ( artifact_type_id ) ;
...
CREATE INDEX idx_default_workflow ON qiita.default_workflow ( software_id ) ;
...
CREATE INDEX idx_default_workflow_command ON qiita.default_workflow_node ( command_id ) ;
CREATE INDEX idx_default_workflow_command ON qiita.default_workflow_node ( default_parameter_set_id ) ;
CREATE INDEX idx_default_workflow_command_0 ON qiita.default_workflow_node ( default_workflow_id ) ;
...
CREATE INDEX idx_default_workflow_edge ON qiita.default_workflow_edge ( parent_id ) ;
CREATE INDEX idx_default_workflow_edge ON qiita.default_workflow_edge ( child_id ) ;
...
CREATE INDEX idx_default_workflow_edge_connections ON qiita.default_workflow_edge_connections ( parent_output_id ) ;
CREATE INDEX idx_default_workflow_edge_connections ON qiita.default_workflow_edge_connections ( child_input_id ) ;
CREATE INDEX idx_default_workflow_edge_connections_0 ON qiita.default_workflow_edge_connections ( default_workflow_edge_id ) ;
...
CREATE INDEX idx_parent_processing_job ON qiita.parent_processing_job ( parent_id ) ;
CREATE INDEX idx_parent_processing_job ON qiita.parent_processing_job ( child_id ) ;
