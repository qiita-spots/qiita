...
COMMENT ON COLUMN qiita.environmental_package.name IS 'The name of the environmental package';
...
COMMENT ON TABLE qiita.study_environmental_package IS 'Holds the 1 to many relationship between the study and the environmental packages';
...
INSERT INTO qiita.environmental_package (name, metadata_table) VALUES
	('air', 'ep_air'),
