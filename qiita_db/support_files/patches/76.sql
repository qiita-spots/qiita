...
UPDATE qiita.analysis 
SET user_id = qiita.qiita_user.qiita_user_id FROM qiita.qiita_user 
WHERE qiita.analysis.email = qiita.qiita_user.email;
...
UPDATE qiita.analysis_users 
SET user_id = qiita.qiita_user.qiita_user_id FROM qiita.qiita_user 
WHERE qiita.analysis_users.email = qiita.qiita_user.email;
...
UPDATE qiita.study_tags 
SET user_id = qiita.qiita_user.qiita_user_id FROM qiita.qiita_user 
WHERE qiita.study_tags.email = qiita.qiita_user.email;
...
UPDATE qiita.processing_job_workflow 
SET user_id = qiita.qiita_user.qiita_user_id FROM qiita.qiita_user 
WHERE qiita.processing_job_workflow.email = qiita.qiita_user.email;
...
UPDATE qiita.study 
SET user_id = qiita.qiita_user.qiita_user_id FROM qiita.qiita_user 
WHERE qiita.study.email = qiita.qiita_user.email;
...
UPDATE qiita.study_users 
SET user_id = qiita.qiita_user.qiita_user_id FROM qiita.qiita_user 
WHERE qiita.study_users.email = qiita.qiita_user.email;
