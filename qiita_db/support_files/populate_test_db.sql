...
-- Insert Analysis
INSERT INTO qiita.analysis (email, name, description, analysis_status_id, pmid, timestamp) VALUES ('test@foo.bar', 'SomeAnalysis', 'A test analysis', 1, '121112', now()), ('test@foo.bar', 'SomeSecondAnalysis', 'Another test analysis', 1, '22221112', now());
