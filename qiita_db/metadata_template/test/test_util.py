...
class TestUtil(TestCase):
    ...
    def setUp(self):
        ...
        self.mfp = join(dirname(abspath(getfile(currentframe()))), "support_files")
    ...
    def test_prefix_sample_names_with_id(self):
        ...
        exp_df = pd.DataFrame.from_dict(exp_metadata_dict, orient="index", dtype=str)
        with warnings.catch_warnings(record=True) as warn:
            qdb.metadata_template.util.prefix_sample_names_with_id(self.metadata_map, 1)
        ...
        metadata_map = pd.DataFrame.from_dict(metadata_dict, orient="index", dtype=str)
        with warnings.catch_warnings(record=True) as warn:
    ...
    def test_load_template_to_dataframe_non_utf8(self):
        replace = EXP_SAMPLE_TEMPLATE.replace("Test Sample 2", "Test Sample\x962")
        qdb.metadata_template.util.load_template_to_dataframe(StringIO(replace))
        # setting back
        replace = EXP_SAMPLE_TEMPLATE.replace("Test Sample\x962", "Test Sample 2")
        qdb.metadata_template.util.load_template_to_dataframe(StringIO(replace))
    ...
    def test_load_template_to_dataframe_typechecking(self):
        ...
        exp = pd.DataFrame.from_dict(SAMPLE_TEMPLATE_LAT_ALL_INT_DICT, dtype=str)
        exp.index.name = "sample_name"
        assert_frame_equal(obs, exp, check_like=True)
        ...
        exp = pd.DataFrame.from_dict(SAMPLE_TEMPLATE_MIXED_FLOAT_INT_DICT, dtype=str)
        exp.index.name = "sample_name"
        assert_frame_equal(obs, exp, check_like=True)
    ...
    def test_load_template_to_dataframe_better_tokenizing_error_msg(self):
        with self.assertRaisesRegex(
            RuntimeError, "Your file has more columns with values than headers"
        ):
            qdb.metadata_template.util.load_template_to_dataframe(
                StringIO(
    ...
    def test_looks_like_qiime_mapping_file(self):
        ...
        obs = qdb.metadata_template.util.looks_like_qiime_mapping_file(StringIO())
        self.assertFalse(obs)
...
SAMPLE_TEMPLATE_DICT_FORM = {
    ...
    "host_subject_id": {
        "2.Sample1": "NotIdentified",
        "2.Sample2": "NotIdentified",
        "2.Sample3": "NotIdentified",
    },
    "latitude": {"2.Sample1": "42.42", "2.Sample2": "4.2", "2.Sample3": "4.8"},
    "longitude": {"2.Sample1": "41.41", "2.Sample2": "1.1", "2.Sample3": "4.41"},
    "physical_location": {
        "2.Sample1": "location1",
        "2.Sample2": "location1",
        "2.Sample3": "location1",
    ...
    "sample_type": {"2.Sample1": "type1", "2.Sample2": "type1", "2.Sample3": "type1"},
    "str_column": {
        "2.Sample1": "Value for sample 1",
        "2.Sample2": "Value for sample 2",
        "2.Sample3": "Value for sample 3",
    },
    "int_column": {"2.Sample1": "1", "2.Sample2": "2", "2.Sample3": "3"},
}
...
SAMPLE_TEMPLATE_LAT_ALL_INT_DICT = {
    ...
    "latitude": {"2.Sample1": "42", "2.Sample2": "4", "2.Sample3": "4"},
    "longitude": {"2.Sample1": "41.41", "2.Sample2": "1.1", "2.Sample3": "4.41"},
    "physical_location": {
        "2.Sample1": "location1",
        "2.Sample2": "location1",
...
SAMPLE_TEMPLATE_MIXED_FLOAT_INT_DICT = {
    ...
    "latitude": {"2.Sample1": "42", "2.Sample2": "4", "2.Sample3": "4.8"},
    "longitude": {"2.Sample1": "41.41", "2.Sample2": "1.1", "2.Sample3": "4.41"},
    "physical_location": {
        "2.Sample1": "location1",
        "2.Sample2": "location1",
...
SAMPLE_TEMPLATE_NUMBER_SAMPLE_NAMES_DICT_FORM = {
    "collection_timestamp": {
        "002.000": "2014-05-29 12:24:51",
        "1.11111": "2014-05-29 12:24:51",
        "0.12121": "2014-05-29 12:24:51",
    },
    "description": {
        "002.000": "Test Sample 1",
        "1.11111": "Test Sample 2",
        "0.12121": "Test Sample 3",
    },
    "has_extracted_data": {"002.000": "True", "1.11111": "True", "0.12121": "True"},
    "has_physical_specimen": {"002.000": "True", "1.11111": "True", "0.12121": "True"},
    "host_subject_id": {
        "002.000": "NotIdentified",
        "1.11111": "NotIdentified",
        "0.12121": "NotIdentified",
    },
    "latitude": {"002.000": "42.42", "1.11111": "4.2", "0.12121": "4.8"},
    "longitude": {"002.000": "41.41", "1.11111": "1.1", "0.12121": "4.41"},
    "physical_location": {
        "002.000": "location1",
        "1.11111": "location1",
        "0.12121": "location1",
    ...
    "sample_type": {"002.000": "type1", "1.11111": "type1", "0.12121": "type1"},
    "str_column": {
        "002.000": "Value for sample 1",
...
QIIME_TUTORIAL_MAP_DICT_FORM = {
    "BarcodeSequence": {"PC.354": "AGCACGAGCCTA", "PC.607": "AACTGTGCGTAC"},
    "LinkerPrimerSequence": {
        "PC.354": "YATGCTGCCTCCCGTAGGAGT",
        "PC.607": "YATGCTGCCTCCCGTAGGAGT",
    },
    "Treatment": {"PC.354": "Control", "PC.607": "Fast"},
    "DOB": {"PC.354": "20061218", "PC.607": "20071112"},
    "Description": {
        "PC.354": "Control_mouse_I.D._354",
