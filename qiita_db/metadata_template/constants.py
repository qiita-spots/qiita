...
PREP_TEMPLATE_COLUMNS_TARGET_GENE = {
    ...
    "demultiplex": Restriction(
        columns={"barcode": str}, error_msg="Demultiplexing disabled."
    ),
    ...
    "demultiplex_multiple": Restriction(
        columns={"barcode": str, "primer": str, "run_prefix": str},
...
FALSE_VALUES = ["No", "no", "NO", "N", "n", "False", "false", "FALSE", "f", "F"]
