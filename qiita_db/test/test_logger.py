...
class LoggerTests(TestCase):
    def test_create_log_entry(self):
        ...
        with self.assertRaises(qdb.exceptions.QiitaDBLookupError):
            ...
            qdb.logger.LogEntry.create("Chicken", "warning message", info={9: 0})

    def test_severity_property(self):
        """"""
        log_entry = qdb.logger.LogEntry.create("Warning", "warning test", info=None)
    ...
    def test_add_info(self):
        ...
        self.assertEqual(
            log_entry.info,
            [{"1": 2, "test": "yeah"}, {"another": "set", "of": "entries", "test": 3}],
        )
