...
class TestPortal(TestCase):
    ...
    def test_add_portal(self):
        ...
        exp = [
            [1, "QIITA", "QIITA portal. Access to all data stored in database."],
            [2, "EMP", "EMP portal"],
    ...
    def test_add_study_portals(self):
        ...
        npt.assert_warns(
            qdb.exceptions.QiitaDBWarning, obs.add_studies, [self.study.id]
        )
    ...
    def test_remove_study_portals(self):
        ...
        obs = npt.assert_warns(
            ...
            self.emp_portal.remove_studies,
            [self.study.id],
        )
    ...
    def test_get_analyses_by_portal(self):
        ...
        exp = {
            qdb.analysis.Analysis(7),
            qdb.analysis.Analysis(8),
            qdb.analysis.Analysis(9),
            qdb.analysis.Analysis(10),
        }
    ...
    def test_remove_analysis_portals(self):
        ...
        obs = npt.assert_warns(
            qdb.exceptions.QiitaDBWarning,
            self.emp_portal.remove_analyses,
            [self.analysis.id],
        )
