...
class SetupTest(TestCase):
    ...
    def test_filepath_type(self):
        self.assertEqual(get_count("qiita.filepath_type"), 11)
    ...
    def test_study_sample_columns(self):
        self.assertEqual(get_count("qiita.study_sample_columns"), 23)
    ...
    def test_raw_data_prep_columns(self):
        self.assertEqual(get_count("qiita.raw_data_prep_columns"), 19)
