...
class TestOntology(TestCase):
    ...
    def _remove_term(self, term):
        ...
        qdb.sql_connection.perform_as_transaction(sql, [self.ontology.id, term])

    def testConvertToID(self):
        self.assertEqual(qdb.util.convert_to_id("ENA", "ontology"), 999999999)

    def testConvertFromID(self):
        self.assertEqual(qdb.util.convert_from_id(999999999, "ontology"), "ENA")
    ...
    def testTerms(self):
        ...
        self.assertEqual(obs, ["WGS", "Metagenomics", "AMPLICON", "RNA-Seq", "Other"])
