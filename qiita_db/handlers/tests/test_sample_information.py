...
class SampleInfoDBHandlerTests(OauthTestingBase):
    def test_get_does_not_exist(self):
        obs = self.get("/qiita_db/sample_information/100/data/", headers=self.header)
    ...
    def test_get(self):
        obs = self.get("/qiita_db/sample_information/1/data/", headers=self.header)
