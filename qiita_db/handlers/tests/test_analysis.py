...
class APIAnalysisMetadataHandlerTests(OauthTestingBase):
    ...
    def test_get(self):
        ...
        exp = {
            "platform": "Illumina",
            "longitude": "95.5088566087",
            "experiment_center": "ANL",
            "center_name": "ANL",
            "run_center": "ANL",
            "run_prefix": "s_G1_L001_sequences",
            "sample_type": "ENVO:soil",
            "common_name": "rhizosphere metagenome",
            "samp_size": ".25,g",
            "has_extracted_data": "True",
            "water_content_soil": "0.101",
            ...
            "qiita_study_title": "Identification of the Microbiomes for Cannabis Soils",
            "tot_nitro": "1.3",
            "depth": "0.15",
            "anonymized_name": "SKM4",
            "tot_org_carb": "3.31",
        }
