...
* The internal Sequence Processing Pipeline is now using the 2023.10.10-gencode-v44/gencode.v44.transcripts.fa.mmi  for Metatranscriptomic data, additional to the human pan-genome reference, together with the GRCh38 genome + PhiX and T2T-CHM13v2.0 genome for human host filtering.
