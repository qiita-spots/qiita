        ...
        self.write(
            {
                "title": study.title,
                "contacts": {
                    "principal_investigator": [pi.name, pi.affiliation, pi.email],
                    "lab_person": [lp.name, lp.affiliation, lp.email],
                },
        ...
        self.write(
            {
                ...
                "sample_information_has_warnings": sample_information_warnings,
