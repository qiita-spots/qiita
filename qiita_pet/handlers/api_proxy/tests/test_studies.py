...
class TestStudyAPI1(TestStudyAPI):
    ...
    def test_study_get_req(self):
        ...
        exp = {
            ...
            "study_info": {
                ...
                "message": "",
                "funding": None,
                "show_biom_download_button": False,
                "publication_pid": [],
                "vamps_id": None,
                "first_contact": datetime(2015, 5, 19, 16, 10),
                "ebi_submission_status": "not submitted",
                "autoloaded": False,
                "show_raw_download_button": False,
                "timeseries_type_id": 1,
                "study_abstract": "ABS",
                "status": "sandbox",
                "spatial_series": None,
    ...
    def test_study_prep_get_req_failed_EBI(self):
        ...
        exp = {"info": temp_info, "message": "", "status": "success"}
        self.assertEqual(obs, exp)
    ...
    def test_study_files_get_req_multiple(self):
        ...
        prep_info = pd.DataFrame.from_dict(prep_info_dict, orient="index", dtype=str)
        pt = npt.assert_warns(
            qdb.exceptions.QiitaDBWarning,
            PREP.create,
            prep_info,
        ...
        study_upload_dir = join(qdb.util.get_mountpoint("uploads")[0][1], str(study_id))
        ...
        obs = study_files_get_req("shared@foo.bar", 1, pt.id, "per_sample_FASTQ")
        exp = {
            "status": "success",
            "num_prefixes": 2,
            "artifacts": [],
        ...
        exp = {
            ...
            "file_types": [
                ...
                (
                    "raw_reverse_seqs",
                    False,
                    sorted(["test_2.R2.fastq.gz", "test_1.R2.fastq.gz"]),
                ),
            ],
        }
        # making sure they are always in the same order
        ...
        exp = {
            ...
            "file_types": [
                ("raw_forward_seqs", True, ["test_2.R1.fastq.gz"]),
        ...
        # to the 3rd column
        obs = study_files_get_req("shared@foo.bar", 1, pt.id, "FASTQ")
        exp = {
            "status": "success",
            "num_prefixes": 2,
            "remaining": ["uploaded_file.txt"],
    ...
    def test_study_patch_request_errors(self):
        ...
        exp = {
            "message": (
                'Operation "no-exists" not supported. Current '
        ...
        obs = study_patch_request("shared@foo.bar", 1, "replace", "/na")
        exp = {
            "message": ('Attribute "na" not found. Please, check the path parameter'),
            "status": "error",
        }
        self.assertEqual(obs, exp)
    ...
    def test_study_patch_request_toggle_public_raw_download(self):
        ...
        obs = study_patch_request(
            "shared@foo.bar", study_id, "replace", "/toggle_public_raw_download", None
        )
        exp = {
            "status": "success",
        ...
        temp_info["18S"] = [
            {
                ...
                "total_samples": 27,
                "ebi_experiment": 27,
                "modification_timestamp": obs_info[0]["modification_timestamp"],
                "creation_timestamp": obs_info[0]["creation_timestamp"],
            },
            {
                "id": 2,
                "status": "private",
                ...
                "ebi_experiment": 27,
                "start_artifact_id": 7,
                "modification_timestamp": obs_info[1]["modification_timestamp"],
                "creation_timestamp": obs_info[1]["creation_timestamp"],
            },
        ]
